...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Yash Bavadiya — Full Stack Developer" },
      { property: "og:description", content: "Portfolio of Yash Bavadiya — projects, writing, and the fun stuff." },
